class CryptoCurrency {
  constructor(
    ...
    a7dayHighAndLow,
    a24hourHighAndLow,
    yesterdaysHighAndLow,
    yesterdaysOpenAndClose,
    yesterdaysChange,
    yesterdaysVolume,
    website,
    sourceCode,
    ...
    this.a24hourVolume = a24hourVolume;
    this.circulatingSupply = circulatingSupply;
    this.totalSupply = totalSupply;
    this.maxSupply = maxSupply;
    this.allTimeHigh = allTimeHigh;
    this.allTimeLow = allTimeLow;
    this.a52weekHighAndLow = a52weekHighAndLow;
    this.a90dayHighAndLow = a90dayHighAndLow;
    this.a30dayHighAndLow = a30dayHighAndLow;
    this.a7dayHighAndLow = a7dayHighAndLow;
    this.a24hourHighAndLow = a24hourHighAndLow;
    this.yesterdaysHighAndLow = yesterdaysHighAndLow;
    this.yesterdaysOpenAndClose = yesterdaysOpenAndClose;
    this.yesterdaysChange = yesterdaysChange;
    this.yesterdaysVolume = yesterdaysVolume;
    ...
    this.tokenInsightRating = tokenInsightRating;
    this.dynamicPerformanceScore = dynamicPerformanceScore;
